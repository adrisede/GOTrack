...
public class HTTPWrapper {
	 ...
	 * @return
	 * An array of three elements that describe the properties of the pubmed id 
	 *  result[0] = types;
		result[1] = notes;
		result[2] = date;
	 */
	 ...
	 * Connects and retrieve the content for a pubmed ID
	 * 
	 * @param pubmedId  pubmed id to query
	 * @return the date associated to that pubmed id in the web page
	 */
