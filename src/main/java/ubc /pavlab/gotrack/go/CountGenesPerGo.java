...
/**
 * 
 * This class is used by Gotrack to compute the number of genes for each goterm
 * 
 * @author asedeno
 * 
 */
public class CountGenesPerGo {
	...
	/**
	 * Function called by gotrack, it will compute the number of direct goterms for each gene id
	 * @param file          GOA file to analyze
	 * @param editionNo     The edition number of "file"
	 * @param countEdition  The variable that will be filled and returned
	 * @param logger        Logger to record the progress
	 * @return The function fill counEdition and then that structure is returned 
	 */
	...
	/**
	 * Function called by gotrack. It will get the number of inferred goterms for each annotation
	 * 
	 * @param file           GOA file
	 * @param editionNo      Edition number of the GOA file
	 * @param countEdition   The structure the will be filled 
	 * @param logger         Logger to record the progress of the function
	 * @return it returns the "countEdition" variable filled with the new information
	 */
	...
	/**
	 * This function is called by countGenesperGo to prepare the variable counEdition
	 * to be filled with data
	 * 
	 * @param file           GOA file to process
	 * @param editionNo      Edition of the GOA file
	 * @param countEdition   Structure to be filled
	 * @param logger         Logger to recorde the progress
	 * @return It return countEdition, it is a map of goterm to an array of 
	 * integers as big as the number of editions, each entry is a the number of
	 * genes associated to that goterm per edition
	 */
