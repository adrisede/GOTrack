...
/**
 * This class implements the multifunctionality analysis called by gotrack class
 * It will create the *.multifunc.score.txt files that will be uploaded to the *_count table
 * @author asedeno 
 * 
 */
