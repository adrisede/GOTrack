 ...
 * This class is not used by gotrack. It was written as part of an exploratory analysis
 * @author asedeno
 * */
public class CountGO {
	 ...
	 */
	public void countGoTerms(String species, String genesFile,
			String datesFile, Logger logger, boolean countLeaves) {
		
		/*	to call from gotrack
		if (doCountGoTerms) {
			CountGO countgo = new CountGO();
